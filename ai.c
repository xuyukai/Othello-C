...
int flag;
int a0,b0;
int model01[9][9],model02[9][9],model03[9][9],value[9][9]={-5120};
int give_pow (int i, int j)
{
    int power[9][9];
    power[1][1]=power[1][8]=power[8][8]=power[8][1]=90;
    power[2][1]=power[1][2]=power[7][1]=power[8][2]=-60;
    power[8][7]=power[7][8]=power[1][7]=power[2][8]=-60;
    power[2][2]=power[2][7]=power[7][2]=power[7][7]=-80;
    power[3][1]=power[4][1]=power[5][1]=power[6][1]=10;
    power[3][8]=power[4][8]=power[5][8]=power[6][8]=10;
    power[1][3]=power[1][4]=power[1][5]=power[1][6]=10;
    power[8][3]=power[8][4]=power[8][5]=power[8][6]=10;
    power[2][3]=power[2][4]=power[2][5]=power[2][6]=5;
    power[7][3]=power[7][4]=power[7][5]=power[7][6]=5;
    power[3][2]=power[4][2]=power[5][2]=power[6][2]=5;
    power[3][7]=power[4][7]=power[5][7]=power[6][7]=5;
    for(i=3;i<=7;i++){
        for(j=3;j<=7;j++){
            power[i][j]=1;
        }
...
{
    int i,j,t,k,n,m,a,b,b1,a1=5760,b2,a2=-5120;
    check(cb,color);
    for(i=1;i<9;i++)
    {
        for(j=1;j<9;j++)
                    ...
                    for(t=1;t<9;t++)
                    {
                        for(k=1;k<9;k++)
                        {
                            if(model01[t][k]==3)
                            {
                                ...
                                model02[t][k]=1-color+1;
                                flip(model02,1-color,t,k);
                                flag=0;
                                check(model02,color);
                                if(flag==0)
                                {
...
int two(int cb[9][9])
{
            ...
            {
                scanf("%d%d",&x,&y);
                if(x<1||x>8||y<1||y>8) printf("     非法输入，请再次输入\n    ");
                else if(cb[x][y]!=3) printf("    非法输入，请再次输入\n    ");
                else
                {
                    system("cls");
                    cb[x][y]=turn+1;
